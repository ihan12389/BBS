<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="java.io.PrintWriter, bbs.Bbs, bbs.BbsDAO, java.util.ArrayList"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
			...
			<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					...
					<tr>
						...
						<td><a href="view.jsp?bbsID=<%=list.get(i).getBbsID()%>&pageNumber=<%=pageNumber%>"><%=list.get(i).getBbsTitle()%></a></td>
