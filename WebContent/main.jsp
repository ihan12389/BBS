<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="java.io.PrintWriter"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				<div class="item active">
					<img src="img/1.jpg" style="width:100%; height:100%; object-fit:'item-active'">
				</div>
				<div class="item">
					<img src="img/2.jpg" style="width:100%; height:100%; object-fit:'item-active'">
				</div>
				<div class="item">
					<img src="img/3.jpg" style="width:100%; height:100%; object-fit:'item-active'">
				</div>
			</div>
