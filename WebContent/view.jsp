<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="java.io.PrintWriter, bbs.Bbs, bbs.BbsDAO"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
	...
	if (bbsID == 0) {
		...
		script.println("locaiotn.href='bbs.jsp");
		script.println("</script>");
	}
	...
	<div class="container">
		<div class="row">
			<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				<thead>
					<tr>
						<th style="background-color: #eeeeee; text-align: center" colspan="3">게시판 글 보기</th>
					</tr>
				</thead>
				<tbody>
					<tr>
		...
		+ bbs.getBbsDate().substring(14, 16) + "분 "%></td>
			...
			<a href="bbs.jsp?pageNumber=<%=request.getParameter("pageNumber") %>" class="btn btn-primary">목록</a>
			<%
				if (userID != null && userID.equals(bbs.getUserID())) {
			%>
			<a href="update.jsp?bbsID=<%=bbs.getBbsID()%>" class="btn btn-primary">수정</a> <a onclick="return confirm('정말로 삭제하시겠습니까?')" href="deleteAction.jsp?bbsID=<%=bbs.getBbsID()%>" class="btn btn-primary">삭제</a>
			<%
				}
			%>
